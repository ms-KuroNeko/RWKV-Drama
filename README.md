...
**【￣^￣】一个基于 *RWKV* 的小玩具，实现简单的角色扮演和剧本推演，支持多人对话**

## 太好了，我是不是可以拿它当免费版ChatGPT用？

- OpenAI一年为了ChatGPT要租几万块A100
- A100 80G 现在国内没有现货，二手和某些不可描述渠道的价格……不跟你多要，拔万
- **如果你觉得这个用两块某鱼上200块钱买一赠一的矿卡就能跑起来的玩意能平替ChatGPT，那不是我脑子有问题就是你脑子有问题**
- **现阶段的绝大多数开源AI大模型都只会胡说八道，只有13B到30B以上的大模型可以稍微有逻辑性的与你进行较长的聊天**
- **而这些东西绝不是你一个普普通通的家用电脑能跑起来的，他至少需要24-80G甚至更多的显存**


⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️

请务必注意，这个系统设计的本意是用来帮助网文写手进行剧情推演，捎带着尝试使用AI参与直播，**跟现有的助手型AI完全是两码事**

本系统的智能水平非常不稳定，**回答无论是从政治与道德角度还是事实正确的角度都极为不可靠，并不具备在生产环境中脱离人类监管独立运作的可能性**

**请不要盲目相信模型输出的任何内容**

**请不要将它用于除了寻找灵感和娱乐之外的任何具体的有风险的可能导致灾难性后果的生产行为**
...
- 等 某鸽子Bo 和 跑路的黄鹤老板 终于玩够了AI写歌开始做 RWKV-5-World-CHNTurned-33B-ProPlusMaxS+
- 继续用JB疯狂攻击小克【指用JailBreak越狱词忽悠Claude陪你过家家】【详见 https://discord.gg/f6bSz8U26S 】

## 这玩意和 *RWKV_Role_Playing* 有啥区别
1. 我讨厌 *Gradio* ，我希望**前后端分离**，这样API设计好了也可以干别的
2. 我想给我自己的基于Scala的AI主播系统整一个RWKV的独立服务器端容器，**只是恰好折腾的过程中有了很多意外收获**
3. 整完了发现不方便测试又顺手写了一个内置的简易前端【不满意可以自己改，改好了给我扔一份】
4. 不小心**实现了一定程度上的多人对话**
5. 不小心**实现了AI模型与角色分离，让AI可以扮演任何一个角色**【当然你也可以只让她扮演一个】
6. **按照我自己的理解迭代了一下内部逻辑，感觉相比 *RWKV_Role_Playing* AI的智商稍微高了一些**，新的逻辑更适合 *RWKV模型* 去理解剧情，更好的扮演人物
7. **这玩意是我拿着 *RWKV_Role_Playing* 的内核自己重新~~换皮~~搓的，我用着顺手【￣^￣】**


## 配置需求

- **24G以上内存**
  - 16G可以运行，但是加载7B模型时会爆内存，需要你用阳寿、运气和虚拟内存帮你顶过去
- **8-16G显存**
  - 7B模型以FP16+INT8混合模式运行需要接近8G显存
  - 7B模型以FP16模式运行需要15G显存
- 不低于
...
# 进阶内容
  ...
  - **Tester** ：H5三件套的纯静态前端
    ...
    - Materialize前端框架
    - 嫌太重了我甚至没试着套个VUE啥的……
    - **我知道很草台，这不是给你们留点装逼的空间吗【明示】【帮我写完，不然我就在这里打滚到你同意为止】**
- HTTP的API接口
  - 不想写了【喵瘫】，我觉得如果有人想用这玩意他一定看得懂代码，都放 *server_with_fastapi.py* 里了
  - 以后有闲心了会补个文档，现在麻烦各位自力更生吧【猫爪抱拳】